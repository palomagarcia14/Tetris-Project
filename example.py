...
def draw_window(surface):
    ...
    surface.blit(tetris_text, (275,25))
...
def main_menu():
    ...
    while run:
        ...
        win.blit(tetris_text, (275, 25))
        win.blit(how2play_text, (285, 150))
        win.blit(instructions1_text, (120,210))
        win.blit(instructions2_text, (110, 235))
        win.blit(instructions3_text, (115, 260))
        win.blit(instructions4_text, (112,285))
        win.blit(instructions5_text, (100,310))
        win.blit(start_text, (235, 400))
        pygame.display.update()
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                run = False
